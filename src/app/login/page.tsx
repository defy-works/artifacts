  ...
  return (
    <div className="flex min-h-[100dvh] flex-col items-center justify-center p-6">
      <div className="rise-in w-full max-w-sm">
        ...
        <div className="num-stamp mb-3 text-center">defy.works · 디파이웍스</div>
        <h1 className="mb-2 text-center font-display text-4xl font-bold tracking-tight">Artifacts</h1>
